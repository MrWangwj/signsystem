<template>
  <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container">
    ...
    <el-form-item prop="account">
      <el-input  class="inputBac" type="text" v-model="ruleForm2.account" auto-complete="off" placeholder="账号"></el-input>
    </el-form-item>
    <el-form-item prop="checkPass">
      <el-input class="inputBac" type="password" v-model="ruleForm2.checkPass" auto-complete="off" placeholder="密码"></el-input>
    </el-form-item>
    <el-form-item prop="captcha">
      <el-col :span="12">
        <div class="grid-content bg-purple">
          <el-input class="inputBac" type="text" v-model="ruleForm2.captcha" auto-complete="off" placeholder="验证码">
          </el-input>
        </div></el-col>
    ...
    <el-form-item style="width:100%;">
      <el-button  style="width:100%; background-color: black; color: white;" @click.native.prevent="handleSubmit" :loading="logining">登录</el-button>
    </el-form-item>
  </el-form>
</template>
