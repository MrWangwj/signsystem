    ...
    getSelStudents: function getSelStudents() {
      ...
      if (groups.length === 0 && positions.length === 0 && sexs.length === 0 && grades.length === 0) {
        ...
        for (var _index in all) {
          ...
          if ((!groups.length || groups.indexOf(all[_index].grouping_id) !== -1) && (!sexs.length || sexs.indexOf(all[_index].sex)) !== -1 && (!grades.length || grades.indexOf(parseInt(_index.substring(2, 4)))) !== -1) {
            //判断用户是否符合选择的条件
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    model: {
      value: (_vm.set.selLocation),
      callback: function($$v) {
        _vm.set.selLocation = $$v
      },
      expression: "set.selLocation"
    }
  }, [_c('checker-item', {
    key: 1,
    staticClass: "group-item",
  ...
  }, [_vm._v("906\n                    ")]), _vm._v(" "), _c('checker-item', {
    key: 2,
    staticClass: "group-item",
    attrs: {
      "value": 2
    }
  }, [_vm._v("910\n                    ")])], 1)], 1)])], 1), _vm._v(" "), _c('carousel-3d', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.type),
