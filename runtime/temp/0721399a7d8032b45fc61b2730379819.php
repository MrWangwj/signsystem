<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\MyDrivers\htdocs\SignSystem2\public/../application/admin\view\manager\renotice.html";i:1478411327;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
				...
				<form action="javascript:alter();" class="form-horizontal" role="form" method="post">
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9" style="margin-left:4%;">
								<button class="btn " type="button" id="notice"  value="<?php echo $data['notice_id']; ?>">
									<i class="icon-ok bigger-110"></i>
									提交
								</button>
								<a  href="<?php echo url('Manager/notice'); ?>">
					...
					cache: false, 
			      	success: function (returndata) {
			      		layer.msg(returndata,{time:1000},function(){
			      			window.location.href = "<?php echo url('Manager/notice'); ?>";
			      		});
			      	},
			      	error:function(){
			      		alert("数据加载失败"); 
