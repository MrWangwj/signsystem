<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\MyDrivers\htdocs\SignSystem2\public/../application/admin\view\manager\renotice.html";i:1476004430;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="row">
				...
				<form action="javascript:alter();" class="form-horizontal" role="form" method="post">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"  placeholder="Username" class="col-xs-10 col-sm-5" required value="公告" >
							</div>
						</div>
						<div class="form-group">
