<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/var/www/html/SignSystem2/public/../application/home/view/index/index.html";i:1476439606;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div id="login_div">
                <form method="post" action="index.html">
                    ...
                    <div id="input_div">
                        ...
                        <button type="button" class="btn btn-success" id="up_btn">登陆</button>
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal" id="into_btn">申请加入</button>
                    </div>
                </form>
            </div>
            <div class="footer">
