<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/var/www/html/SignSystem/public/../application/admin/view/sign/index.html";i:1501053470;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
//                layer.msg("加载成功", {time : 1000});
                $(".up").click(function () {
                    var datas = $(this).parent().parent().find('td');
                    var id =  datas.eq(0).html();
                    var userid = datas.eq(2).html();
                    var starTime = datas.eq(3).html();
                    var overTime = datas.eq(4).html();
