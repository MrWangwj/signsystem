<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\MyDrivers\htdocs\SignSystem2\public/../application/admin\view\index.html";i:1474985362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo url('admin/sign/index'); ?>">签到日志管理</a>
                        </li>
                    </ul>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo url('admin/user/index'); ?>">当前在线</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo url('admin/user/index'); ?>">人员分组</a>
                        </li>
                    </ul>
                </li>
            </ul>
