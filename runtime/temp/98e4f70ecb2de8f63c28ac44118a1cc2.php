<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\MyDrivers\htdocs\SignSystem2\public/../application/admin\view\manager\manager.html";i:1478326154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2"  placeholder="Username" class="col-xs-10 col-sm-5" required >
										</div>
									</div>
									<div class="form-group">
