<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/var/www/html/SignSystem/public/../application/home/view/index/index.html";i:1501053472;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <div class="modal-body" id="body1">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                           <label class="col-sm-2 control-label">性别：</label>
                            <div class="col-sm-9" style="margin-top:3px;">
                                <input name="user_sex" type="radio" id="sex-1"  value="0" checked="checked">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="grade" type="radio" id="grade-1"  value="16" checked="checked">
                                <label for="grade-1">大一</label>
                                <input name="grade" type="radio" id="grade-2"  value="15">
                                <label for="grade-2">大二</label>
                                <input name="grade" type="radio" id="grade-3"  value="14">
...
<script>
    ...
    function login(){
        ...
        $.post("<?php echo url('home/index/docheck'); ?>",{'userid':userId},function (data) {
            if(data.code==-1){
                ...
                layer.msg('玩命卖萌中',{
                    ...
                    window.location.href="<?php echo url('home/homepage/index'); ?>";
                });
