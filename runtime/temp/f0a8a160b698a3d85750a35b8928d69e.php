<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/var/www/html/SignSystem2/public/../application/home/view/user/message.html";i:1476692609;s:74:"/var/www/html/SignSystem2/public/../application/home/view/public/base.html";i:1476866176;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<div style="margin-top:10px;">
		<div style="margin: 0;padding: 8px 20px 24px;">
			<div class="row" style="border:4px solid #1AB394;width:100%;margin: auto;">
				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" method="post" action="javascript:adduser();">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<img src="" style="border:2px solid #1AB394;width:100px;height:100px;">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo $data['position_name']; ?>" readonly="readonly" required>					
							</div>
						</div>
						...
						<div class="clearfix form-actions" >
							<div class="col-md-offset-3 col-md-9">
								<button  style="width:87px;height:45px;color:#fff; background-color: #1AB394;border:none;border-radius: 8px;" type="submit">
								...
								&nbsp; &nbsp; &nbsp;
								<a href="">
								<button class="btn" type="button"style="border-radius: 8px;">
