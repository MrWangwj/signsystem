<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\MyDrivers\htdocs\SignSystem2\public/../application/admin\view\manager\remanager.html";i:1474989449;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			$.ajax({
				...
				cache: false, 
		      	success: function (returndata) {
		      		alert(returndata);
		      		window.location.href = '/houtai/public/index.php/admin/User/member';
		      	},
		      	error:function(){
		      		alert("数据加载失败"); 
		      	},
