<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\MyDrivers\htdocs\SignSystem2\public/../application/admin\view\user\useradd.html";i:1478351372;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!-- 														<td>
								...
								<div class="cf" style="folat:right;width:100px;">
                               		 <input id="agree" class="btn btn-outline " type="button" value="同意">                              		 
                            	</div>
