<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/var/www/html/SignSystem2/public/../application/admin/view/user/member.html";i:1476449266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>	
														...
														<td class="hidden-480"><?php if($vo['sex'] == '0'): ?>
														男
														<?php else: ?>
														女
														<?php endif; ?>
