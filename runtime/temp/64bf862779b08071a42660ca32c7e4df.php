<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\MyDrivers\htdocs\SignSystem2\public/../application/admin\view\login.html";i:1476368150;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="signin-info">
                ...
                <div class="m-b"></div>
                <h4>欢迎使用 <strong>三月签到后台管理系统</strong></h4>
                <ul class="m-b">
