<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\MyDrivers\htdocs\SignSystem2\public/../application/admin\view\user\member.html";i:1475210975;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<button class="btn btn-xs btn-info" type="submit" onclick="update();">
																	<a href="<?php echo \think\Config::get('parse_str.__MODULE__'); ?>/Manager/remanager/user_id/<?php echo $vo['user_id']; ?>"><i class="icon-edit bigger-120"></i></a>
																</button>
