<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\MyDrivers\htdocs\SignSystem2\public/../application/admin\view\user\member.html";i:1478411194;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="row" style="float:left; width:100%;margin:0 0 10px 0;">
						

									 	<a class="btn btn-outline "  href="<?php echo url('Manager/manager'); ?>">新增</a>
                                		...
                                		<button type="submit"  class="btn  btn-sm" onclick="search();"/>
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="hidden-480">组  别</th>
														<th class="hidden-480">职  务</th>
								...
								<div class="cf" style="folat:right;width:100px;">
                               		 <input id="submit" class="btn btn-outline " type="button" value="删除">                              		 
                            	</div>
