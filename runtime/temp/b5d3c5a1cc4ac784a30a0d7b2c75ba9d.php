<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/var/www/html/SignSystem/public/../application/admin/view/group/group.html";i:1501053469;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
									...
									<tbody>
										<?php if(is_array($info) || $info instanceof \think\Collection): if( count($info)==0 ) : echo "" ;else: foreach($info as $key=>$vo): ?>
											<tr>
												...
												<td >
													<?php if(is_array($data) || $data instanceof \think\Collection): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($i % 2 );++$i;if($vo['group_id'] == $vi['group_id']): ?>
															<?php echo $vi['name']; ?>&nbsp
														<?php endif; endforeach; endif; else: echo "" ;endif; ?>	
												</td>
												<td style="width:120px;margin:auto;height: 42px;display: block;">
