<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/var/www/html/SignSystem2/public/../application/admin/view/index.html";i:1476956309;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo url('admin/statistics/index'); ?>">本周考勤统计</a>
                        </li>
                    </ul>
                    <ul class="nav nav-second-level">
                        <li>
